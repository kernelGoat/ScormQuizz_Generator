...
function RecordTest(score){
    ...
    ScormProcessSetValue("cmi.core.score.max", "20");
    ...
    //set exit to normal
    ScormProcessSetValue("cmi.core.exit", "logout");
    ScormProcessFinish();   //--> deconnect from LMS 
...
function loadFunction() {
    ...
    if ( initialized == true ) console.log('LMS inisialise avec succees ' );
}


function startTimer(params) {

    let minutes = parseInt(params.period);
    let secondes = 59;
    let m = 0;
    let s = 0;
